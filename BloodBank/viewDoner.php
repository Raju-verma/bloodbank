		...
		<div class="row">
			   ...
			   <div class="col-md-12">
			   		<div class="panel panel-default">
						...
						<h3 class="panel-title" align="center">View Donor</h3>
						</div>
					<div class="panel-body">
					<div class="col-md-12" align="center">
						<h4>Select Blood Group For Donor</h4>
					</div>
							<form role="form" id="membersch" class="form-horizontal" action="viewDoner1.php" method="post">
								<div class="form-group">
									<div class="col-md-3">
									</div>
									<label for="Member ID" class="col-sm-2 " >Blood Group</label>
									<div class="col-sm-4">
