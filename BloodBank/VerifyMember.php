<?php
	...
	$sql1="select * from memberinfo where status='No'";
			   ...
			   <div class="col-md-12">
					...
					<div class="col-md-12" align="center">
						<h4>List of Member (Not Verified)</h4>
							...
							<form role="form" id="membersch" class="form-horizontal" action="verifymember1.php" method="post">
								<div class="form-group">
									...
									{
									?>
										<option value="<?php echo $row1['mid'];?>"><?php echo $row1['mid'];?></option>
									<?php
									}
									?>
									</select>
